...
import api, { formatMoney, formatDate, EXPENSE_CATEGORIES } from '../utils/api'
...
export default function Analyses() {
  ...
  const loadData = async () => {
    try {
      ...
      setAllTransactions(apiTrans)
    } catch (e) {
      console.warn('API indisponible, aucune donnée chargée')
      setAllTransactions([])
    } finally {
      setLoading(false)
    }
          ...
          <>
                ...
                {stats.byDay.map((v, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <div
                          className={`absolute -top-6 left-1/2 -translate-x-1/2 px-1.5 py-0.5 rounded text-[9px] font-mono opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap ${isDark
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                ...
                <p
                  className={`text-sm font-medium font-mono ${isDark ? 'text-seka-text' : 'text-gray-900'
                    }`}
                >
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                ...
                <p
                  className={`text-lg font-bold font-mono ${isDark ? 'text-seka-text' : 'text-gray-900'
                    }`}
                >
              ...
              >
                ...
                <p className="text-lg font-bold text-seka-red font-mono">
                  ...
                  {stats.top5.map((t, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="text-sm font-mono text-seka-red font-semibold">
                    ...
                    return (
                      <div key={i}>
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span
                            className={`text-xs font-mono w-20 text-right ${isDark ? 'text-seka-text' : 'text-gray-900'
                              }`}
                          >
